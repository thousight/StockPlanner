...
3. **Generate Code to do the math** Build a tool that can execute python code generated by LLM to do the math.
...
1. **Timestamping:** Always display _when_ the data was fetched (e.g., "Data as of 10:00 AM").
